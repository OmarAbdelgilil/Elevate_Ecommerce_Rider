...
class MockUploadImageApiManager extends _i1.Mock
    implements _i13.UploadImageApiManager {
  MockUploadImageApiManager() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i9.Future<_i14.UpdateProfileImageResponse?> uploadImage(_i15.File? image) =>
      (super.noSuchMethod(
        Invocation.method(
          #uploadImage,
          [image],
        ),
        returnValue: _i9.Future<_i14.UpdateProfileImageResponse?>.value(),
      ) as _i9.Future<_i14.UpdateProfileImageResponse?>);
}
