...
class _ApiManager implements ApiManager {
  ...
  @override
  Future<OrderResponse2?> getAllOrders() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderResponse2>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late OrderResponse2? _value;
    try {
      _value =
          _result.data == null ? null : OrderResponse2.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
