...
class _ApiManager implements ApiManager {
  ...
  @override
  Future<ApplyResponse> applyWithFiles(FormData formData) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = formData;
    final _options = _setStreamType<ApplyResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  Future<VehicleResponse> getVehicles() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<VehicleResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VehicleResponse _value;
    try {
      _value = VehicleResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<StartOrderResponse> startOrder(String orderID) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<StartOrderResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
