...
// in elevate_ecommerce_driver/test/features/auth/update_password/data/dataSource/updatePassword_OnlineDataSourse_impl_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUserProvider extends _i1.Mock implements _i18.UserProvider {
  MockUserProvider() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  void setUser(_i19.User? user) => super.noSuchMethod(
        Invocation.method(
          #setUser,
          [user],
        ),
